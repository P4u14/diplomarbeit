...
class DataLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        frame_name = self.data_path + '/' + self.names[index]

        img = Image.open(frame_name).convert('RGB')
    ...
    def __retrive_permutations(self, classes):
        ...
        path = 'ssl/pretext/jigsaw_permutation/permutations/permutations_hamming_max_%d.npy' % (classes)
        try:
